...
//       testProject.projectName(), FrameData.initial(testProject.projectName(), FrameTransform.baseFrame()));
...
//   // * Align new frame
//   final homography =
//       await ImageTransformer.findHomography(testProject, testFrame.getFramePng().path);
//
//   if (homography == null) {
