...
class _FrameEditorState extends State<FrameEditor>
    ...
    showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              actions: [
                ...
                TextButton(
                    onPressed: () {
                      final newX = double.tryParse(xController.text) ??
                          marker['offset'].dx;
                      final newY = double.tryParse(yController.text) ??
                          marker['offset'].dy;
  ...
  Future<void> accessBackendPhotos() async {
    ...
    // * Create test project
    final testProject =
        (await TimelapseStore.createProject(widget._projectName)) ??
            (await TimelapseStore.getProject(widget._projectName));
    ...
    try {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        ...
        if (pngBytes != null) {
          // Proceed with saving
          final frame =
              await TimelapseFrame.fromExisting(projectName, frameUuid);
                  ...
                  onTapUp: (details) {
                    ...
                    setState(() {
                      if (currentImageIndex == 0) {
                        _respectiveName =
                            'Marker ${markersForEachImage[currentImageIndex].length + 1}';
                      ...
                      if (currentImageIndex > 0) {
                        _respectiveName = (markersForEachImage[
                                    currentImageIndex - 1]
                                [markersForEachImage[currentImageIndex].length]
                            ['name']);
                        markersForEachImage[currentImageIndex].add({
                          'offset': localPosition,
                          'name': _respectiveName,
                        ...
                        if (markersForEachImage[currentImageIndex].length !=
                            markersForEachImage[currentImageIndex - 1].length) {
                          _respectiveName =
                              (markersForEachImage[currentImageIndex - 1][
                          ...
                          child: ColorFiltered(
                            ...
                            child: ColorFiltered(
                              ...
                              child: ColorFiltered(
                                ...
                                child: theImage != null
                                    ? Image.file(File(theImage!),
                                        fit: BoxFit.cover)
                                    : Text('Image at $theImage is loading...'),
                              ),
                            ),
                          ),
                        ),
                        ...
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                title: Text(marker[
                                    'name']), //_respectiveName == null ? Text(_respectiveName) : Text('Sam'),
                                subtitle: Text('''
